          ...
          <div className="flex justify-between items-center h-16">
            ...
            {homepage ? (
              <div className="hidden md:flex items-center space-x-4">
                <Link href="/students" className="text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-sm px-4 py-2 transition-all">For Students</Link>
                <Link href="/mentors" className="text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-sm px-4 py-2 transition-all border border-gray-800">For Mentors</Link>
              </div>
            ) : (
              <div className="hidden md:flex items-center space-x-4">
