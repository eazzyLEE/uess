...
export default function Mentors() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    else if (!formData.school || formData.school === 'Select School')
      newErrors.school = 'Please select your school';
    else if (!formData.yearOfGraduation)
      newErrors.yearOfGraduation = 'Year of graduation is required';
    else if (!formData.country) newErrors.country = 'Country is required';
    else if (!formData.numberOfStudents)
      newErrors.numberOfStudents = 'Number of students is required';
    else if (isNaN(Number(formData.numberOfStudents)))
      newErrors.numberOfStudents = 'Number of students must be a number';
    // else if (Number(formData.numberOfStudents) < 1 || Number(formData.numberOfStudents) > 3) newErrors.numberOfStudents = 'Number of students must be between 1 and 3'
      ...
      newErrors.career = 'Please select your career path';
    else if (formData.career === 'Other' && !formData.otherCareerPath)
